...
<body>
    ...
    <div class="content">
        ...
        <div class="form-container">
            <form action="/matches/update/<?= $match['id'] ?>" method="post">
                <?= csrf_field(); ?>

                <div class="form-group">
                    <label for="tournament_id">ID Turnamen</label>
                    <input type="text" name="tournament_id" value="<?= $match['tournament_id'] ?>" required>
                </div>

                <div class="form-group">
                    <label for="team1_id">ID Tim 1</label>
                    <input type="text" name="team1_id" value="<?= $match['team1_id'] ?>" required>
                </div>

                <div class="form-group">
                    <label for="team2_id">ID Tim 2</label>
                    <input type="text" name="team2_id" value="<?= $match['team2_id'] ?>" required>
                </div>
