...
<div class="container">
    ...
    <form action="/pemeriksaan/update/<?= esc($pemeriksaan['id_pemeriksaan']) ?>" method="post">
        <?= csrf_field() ?>

        <div class="mb-3">
            <label for="id_pasien">ID Pasien:</label>
            <input type="text" id="id_pasien" name="id_pasien" value="<?= esc($pemeriksaan['id_pasien']) ?>" required>
        ...
        <div class="mb-3">
            ...
            <input type="text" id="id_dokter" name="id_dokter" value="<?= esc($pemeriksaan['id_dokter']) ?>" required>
        ...
        <div class="mb-3">
            ...
            <input type="text" id="hasil_pemeriksaan" name="hasil_pemeriksaan" required><?= esc($pemeriksaan['hasil_pemeriksaan']) ?></input>
        ...
        <div class="mb-3">
            ...
            <input type="date" id="tanggal_pemeriksaan" name="tanggal_pemeriksaan" value="<?= esc($pemeriksaan['tanggal_pemeriksaan']) ?>" required>
